...
## Cria um formulário para o cadastro de usuários
...
# Cria o formulário de novos alunos da turma
class AddAlunoForm(forms.ModelForm):
	...
	college_enrollment = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder" : "Matrícula", "class": "form-control"}), label = "")
	birth_date = forms.DateField(input_formats=['%d/%m/%Y'], required=True, widget=forms.widgets.DateInput(attrs={"placeholder" : "Data de Nascimento", "class": "form-control"}), label = "")
